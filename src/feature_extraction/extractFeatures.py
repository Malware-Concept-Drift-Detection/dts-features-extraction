...
def extractFeatures(sha1_family,N,genericsFlag=False,headersFlag=False,allSections=None,topDlls=None,topImports=None,topStrings=None,topN_grams=None,topOpcodes=None):
    #Singleton
