...
def update_label_data_frame(experiment, sample_list):
    filepath = os.path.join(experiment, config.DATASET_DIRECTORY, 'labels.pickle')
...
#     dataset = pd.read_csv(os.path.join(experiment, config.DATASET_DIRECTORY, 'sha256_family.csv'))
#     if not binary:
